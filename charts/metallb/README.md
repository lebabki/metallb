...
| frr-k8s.prometheus.rbacProxy.repository | string | `"quay.io/brancz/kube-rbac-proxy"` |  |
| frr-k8s.prometheus.rbacProxy.tag | string | `"v0.18.0"` |  |
...
| prometheus.rbacProxy.repository | string | `"quay.io/brancz/kube-rbac-proxy"` |  |
